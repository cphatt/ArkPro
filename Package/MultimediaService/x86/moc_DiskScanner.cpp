...
**
** Created: Wed Oct 18 10:36:36 2017
...
void DiskScanner::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        DiskScanner *_t = static_cast<DiskScanner *>(_o);
        switch (_id) {
        case 0: _t->finish(); break;
        case 1: _t->filePath((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const int(*)>(_a[2]))); break;
...
const QMetaObjectExtraData DiskScanner::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject DiskScanner::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DiskScanner,
      qt_meta_data_DiskScanner, &staticMetaObjectExtraData }
};
