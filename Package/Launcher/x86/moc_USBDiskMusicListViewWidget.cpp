...
void USBDiskMusicListViewWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        USBDiskMusicListViewWidget *_t = static_cast<USBDiskMusicListViewWidget *>(_o);
        switch (_id) {
        ...
        case 4: _t->onMusicPlayerID3TagChange((*reinterpret_cast< const int(*)>(_a[1])),(*reinterpret_cast< const int(*)>(_a[2])),(*reinterpret_cast< const QString(*)>(_a[3])),(*reinterpret_cast< const int(*)>(_a[4]))); break;
        case 5: _t->onMusicListViewItemRelease((*reinterpret_cast< const int(*)>(_a[1]))); break;
...
const QMetaObjectExtraData USBDiskMusicListViewWidget::staticMetaObjectExtraData = {
...
const QMetaObject USBDiskMusicListViewWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_USBDiskMusicListViewWidget,
      qt_meta_data_USBDiskMusicListViewWidget, &staticMetaObjectExtraData }
};
