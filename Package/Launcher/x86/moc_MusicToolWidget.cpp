...
void MusicToolWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        MusicToolWidget *_t = static_cast<MusicToolWidget *>(_o);
        switch (_id) {
        ...
        case 4: _t->onTickMarksMillesimalStart((*reinterpret_cast< const int(*)>(_a[1]))); break;
        case 5: _t->onTickMarksMillesimalEnd((*reinterpret_cast< const int(*)>(_a[1]))); break;
        case 6: _t->onTickMarksMillesimalChanged((*reinterpret_cast< const int(*)>(_a[1]))); break;
        case 7: _t->onToolButtonRelease(); break;
...
const QMetaObjectExtraData MusicToolWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MusicToolWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MusicToolWidget,
      qt_meta_data_MusicToolWidget, &staticMetaObjectExtraData }
};
