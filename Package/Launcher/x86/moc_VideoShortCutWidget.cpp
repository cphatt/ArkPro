...
**
** Created: Mon Oct 23 15:07:54 2017
...
void VideoShortCutWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        VideoShortCutWidget *_t = static_cast<VideoShortCutWidget *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData VideoShortCutWidget::staticMetaObjectExtraData = {
...
const QMetaObject VideoShortCutWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_VideoShortCutWidget,
      qt_meta_data_VideoShortCutWidget, &staticMetaObjectExtraData }
};
