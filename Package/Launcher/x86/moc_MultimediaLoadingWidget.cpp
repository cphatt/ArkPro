...
**
** Created: Wed Oct 18 10:38:42 2017
...
void MultimediaLoadingWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData MultimediaLoadingWidget::staticMetaObjectExtraData = {
...
const QMetaObject MultimediaLoadingWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MultimediaLoadingWidget,
      qt_meta_data_MultimediaLoadingWidget, &staticMetaObjectExtraData }
};
