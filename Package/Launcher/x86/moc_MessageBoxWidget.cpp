...
void MessageBoxWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData MessageBoxWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MessageBoxWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MessageBoxWidget,
      qt_meta_data_MessageBoxWidget, &staticMetaObjectExtraData }
};
