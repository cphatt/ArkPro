...
void SDDiskVideoListViewWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        SDDiskVideoListViewWidget *_t = static_cast<SDDiskVideoListViewWidget *>(_o);
        switch (_id) {
        ...
        case 4: _t->onVideoListViewItemRelease((*reinterpret_cast< const int(*)>(_a[1]))); break;
...
const QMetaObjectExtraData SDDiskVideoListViewWidget::staticMetaObjectExtraData = {
...
const QMetaObject SDDiskVideoListViewWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SDDiskVideoListViewWidget,
      qt_meta_data_SDDiskVideoListViewWidget, &staticMetaObjectExtraData }
};
