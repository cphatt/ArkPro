...
void IdleWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData IdleWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject IdleWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_IdleWidget,
      qt_meta_data_IdleWidget, &staticMetaObjectExtraData }
};
