...
**
** Created: Wed Oct 18 10:38:54 2017
...
void CarplayShortCutWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        CarplayShortCutWidget *_t = static_cast<CarplayShortCutWidget *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData CarplayShortCutWidget::staticMetaObjectExtraData = {
...
const QMetaObject CarplayShortCutWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CarplayShortCutWidget,
      qt_meta_data_CarplayShortCutWidget, &staticMetaObjectExtraData }
};
