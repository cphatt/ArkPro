...
**
** Created: Mon Oct 23 15:07:47 2017
**      by: The Qt Meta Object Compiler version 63 (Qt 4.8.1)
**
** WARNING! All changes made in this file will be lost!
*****************************************************************************/

#include "../../../Launcher/UserInterface/MainWidget/DiskWidget/SDDiskWidget/SDDiskWidget.h"
...
void SDDiskWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        SDDiskWidget *_t = static_cast<SDDiskWidget *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData SDDiskWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SDDiskWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SDDiskWidget,
      qt_meta_data_SDDiskWidget, &staticMetaObjectExtraData }
};
...
void *SDDiskWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Widget::Interface"))
        return static_cast< Widget::Interface*>(const_cast< SDDiskWidget*>(this));
    if (!strcmp(_clname, "Multimedia::Interface"))
        return static_cast< Multimedia::Interface*>(const_cast< SDDiskWidget*>(this));
