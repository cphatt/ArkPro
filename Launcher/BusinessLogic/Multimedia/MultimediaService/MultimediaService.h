...
#define MULTIMEDIASERVICE               QString("com.arkmicro.multimedia")
#define MULTIMEDIAPATH                  QString("/com/arkmicro/multimedia")
#define MULTIMEDIAINTERFACE             QString("Local.DbusServer.Multimedia")
...
private:
    ...
    QSharedPointer<MultimediaServicePrivate> m_Private;
};
