...
void LinkWidget::resizeEvent(QResizeEvent *event)
{
    ...
    g_Widget->geometryFit(130 - 100, (g_Widget->baseWindowHeight() - height) * 0.4 + height, 200, 29, m_Private->m_MirrorBtnText);
 //   g_Widget->geometryFit(30, (g_Widget->baseWindowHeight() - height) * 0.5 + height, 572, 120, m_Private->m_MirrorTipText);

    g_Widget->geometryFit(270, 117, width, height, m_Private->m_CarlifeBtn);
    g_Widget->geometryFit(130 - 100 + 270, (g_Widget->baseWindowHeight() - height) * 0.4 + height, 200, 29, m_Private->m_CarlifeBtnText);
...
void LinkWidgetPrivate::initialize()
{
   ...
   // m_Background->setBackgroundBmpPath(QString(":/Images/Resources/Images/LinkWidgetBackground"));
    ...
    m_MirrorBtn->setPressBmpPath(QString(":/Images/Resources/Images/LinkWidgetMirrorBtnPress"));
    ...
    m_CarlifeBtn->setNormalBmpPath(QString(":/Images/Resources/Images/LinkWidgetCarlifeBtnNormal"));
    m_CarlifeBtn->setPressBmpPath(QString(":/Images/Resources/Images/LinkWidgetCarlifeBtnPress"));
