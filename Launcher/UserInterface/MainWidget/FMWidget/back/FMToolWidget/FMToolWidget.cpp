...
{
    g_Widget->geometryFit(139, 12, 1002, 552, this);
...
void FMToolWidget::onVolumeRangeChange(const int min, const int max)
{
}
...
{
    connectSignalAndSlotByNamesake(g_AudioManager, m_Parent);
